...
declare type FabricCanvas<T extends any = fabric.Canvas> = T &
  FabricCanvasOption;
...
declare interface FabricEvent<T extends any = Event>
...
declare type FabricObject<T extends any = fabric.Object> = T &
  FabricObjectOption;
